...
Model.prototype.formatModel = function (document) {
    ...
    formattedDocument.id = document.id;
    formattedDocument.firstname = document.firstname;
    formattedDocument.lastname = document.lastname;
    formattedDocument.createdAt = document.createdAt;
    formattedDocument.updatedAt = document.updatedAt;
